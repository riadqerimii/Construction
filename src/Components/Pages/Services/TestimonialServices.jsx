      ...
      <Container className="pt-5 mt-5">
        ...
        <Slider {...settings} className="pb-3">
          {testimonialsData.map((testimonial, index) => (
            <div key={index} className="px-5 pb-5" data-aos="fade-up">
              <Card className="card-1 p-5 ">
                <img src={testimonial.image} alt="" />
                <h3 className="text-start" data-aos="fade-up">
                  {testimonial.name}
                </h3>
                <h4 className="text-start" data-aos="fade-up">
                  {testimonial.role}
                </h4>
                <div className="d-flex py-3" data-aos="fade-up">
